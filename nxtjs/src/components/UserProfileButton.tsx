...
export default function UserProfileButton({ className, ...props }: { className?: string, [key: string]: any }) {
    ...
    return (
        <div className={twMerge("flex items-center justify-center' bg-red-400 bg-opacity-40 dark:hover:bg-neutral-200/40 border-gray-300 shadow-sm dark:border-neutral-800 backdrop-blur-md p-1 rounded-full", className)} {...props} style={{backgroundColor: theme === "dark" ? "rgba(255,255,255, 0.03)" : "#f9fafb", borderWidth: 1}}>
